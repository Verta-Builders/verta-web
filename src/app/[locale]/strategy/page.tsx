                        ...
                        <div className="flex justify-between items-start mb-12 relative z-10">
                            <div className="max-w-4xl">
                                ...
                                <p className="text-dark-300 text-xl lg:text-2xl font-light leading-relaxed max-w-2xl font-display drop-shadow-sm">
                                    Αγαπητέ-ή συνεργάτη-τιδα, οι παρακάτω ερωτήσεις θα μας βοηθήσουν να κατανοήσουμε το όραμά σας και να δημιουργήσουμε μια ιστοσελίδα που αντικατοπτρίζει απόλυτα την επαγγελματική σας ταυτότητα.
                                </p>
                            </div>
                        </div>
                    </motion.div>
